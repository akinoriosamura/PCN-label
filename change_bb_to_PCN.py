...
class ImageDate():
    ...
    def convert_data(self):
        ...
        if self.img is not None:
            face_count, windows = get_PCN_result(self.img, detector)
...
if __name__ == '__main__':
    ...
    DatasetDir = "/data/dataset/dlib_xml/"
    labelPath = os.path.join(DatasetDir, "dlib_68.txt")
    newlabelPath = os.path.join(DatasetDir, "pcn_bb_dlib_68.txt")
